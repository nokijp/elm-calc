...
validExpressions =
  ...
  , (" 1 + 2 * 3 ^ 4 ", Add (Number 1.0) (Mul (Number 2.0) (Pow (Number 3.0) (Number 4.0))))
  , (" 1 ^ 2 ^ 3 ", Pow (Pow (Number 1.0) (Number 2.0)) (Number 3.0))
  , (" 1 ^ ( 2 ^ 3 ) ", Pow (Number 1.0) (Pow (Number 2.0) (Number 3.0)))
  , (" - 1 ", Negate (Number 1.0))
  , (" 1 + - 2 ", Add (Number 1.0) (Negate (Number 2.0)))
  , (" 1 * - 2 ", Mul (Number 1.0) (Negate (Number 2.0)))
  , (" 1 ! ", Factorial (Number 1.0))
  , (" 1 ! ! ", Factorial (Factorial (Number 1.0)))
  , (" 1!! ", Factorial (Factorial (Number 1.0)))
  , (" ( 1 ) ! ", Factorial (Number 1.0))
  , (" ( ( 1 ) ! ) ! ", Factorial (Factorial (Number 1.0)))
  , (" 1 + 2 ! ^ 3 ! + 4 ", Add (Add (Number 1.0) (Pow (Factorial (Number 2.0)) (Factorial (Number 3.0)))) (Number 4.0))
  , (" sqrt ( 1 ) ", Apply1 Sqrt (Number 1.0))
  , (" exp ( 1 ) ", Apply1 Exp (Number 1.0))
  , (" log ( 1 ) ", Apply1 Log (Number 1.0))
  , (" sin ( 1 ) ", Apply1 Sin (Number 1.0))
  , (" cos ( 1 ) ", Apply1 Cos (Number 1.0))
  , (" tan ( 1 ) ", Apply1 Tan (Number 1.0))
  , (" pow ( 1 , 2 ) ", Apply2 PowFunc (Number 1.0) (Number 2.0))
  , (" 1 + exp ( 2 ) + 3 ", Add (Add (Number 1.0) (Apply1 Exp (Number 2.0))) (Number 3.0))
  , (" v ", Variable "v")
  , (" v0 ", Variable "v0")
  , (" abc ", Variable "abc")
  ...
  , (" 1 + 2 / 3 * sin ( 4 ) + 5 ", Add (Add (Number 1.0) (Mul (Div (Number 2.0) (Number 3.0)) (Apply1 Sin (Number 4.0)))) (Number 5.0))
  , ("1+2/3*sin(4)+5", Add (Add (Number 1.0) (Mul (Div (Number 2.0) (Number 3.0)) (Apply1 Sin (Number 4.0)))) (Number 5.0))
  ]
